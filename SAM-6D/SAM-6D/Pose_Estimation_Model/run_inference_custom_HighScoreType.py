...
def get_test_data(rgb_path, depth_path, cam_path, cad_path, seg_path, det_score_thresh, cfg):
    ...
    init_score = 0
    for det in dets_:
        if det['score'] > init_score:
            dets.clear()
            dets.append(det)
            init_score = det['score']
    del dets_
    ...
    print('all_rgb',len(all_rgb))
    print('all_cloud',len(all_cloud))
    print('all_rgb_choose',len(all_rgb_choose))
    print('all_rgb_choose',len(all_rgb_choose))
    print('all_score',len(all_score))
    print('all_dets',len(all_dets))
