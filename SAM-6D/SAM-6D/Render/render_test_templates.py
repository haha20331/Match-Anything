...
parser.add_argument('--cad_path'default="/workspace/SAM-6D/SAM-6D/Data/Example/output_test_mesh.ply",, help="The path of CAD model")
parser.add_argument('--output_dir'default="/workspace/SAM-6D/SAM-6D/Data/Example/outputs",, help="The path to save CAD templates")
